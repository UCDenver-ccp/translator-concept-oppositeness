...
My data: I ran my script findAntonyms.pl on PATO version 2021-03-10.  Then I used the pullIDPairs.pl script (see above) to pull out just the IDs and do the necessary sorting.

Finally, I used the UNIX utility _comm -12 reference.file my.file_ to look for overlaps, if there be any.
