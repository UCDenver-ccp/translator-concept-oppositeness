...
*NB*: I might need to rerun my script on PATO--I think that the version of the script that I used produces duplicates opp(x, y) and opp(y, x), which is fixed in later versions. I think/hope :-)
