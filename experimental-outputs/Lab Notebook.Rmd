...
* to	49 from	16 towards	1
* directly	18
* indirectly	8 indirect	2 direct	2
...
## PATO: opposites already annotated
...
print("In both mine and 'current':")
print(both.mine.and.current)
print("In mine only:")
print(pato.mine.only)
print("In 'current' only:")
print(current.only)
...
# PICK IT UP FROM HERE--I NEED TO RERUN MY STUFF ON HP, CLEARLY
