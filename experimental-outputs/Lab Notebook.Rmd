...
1. Started by manually building a list
2. Then searched HPO
3. Comparing the two: we need to take synonymy into account where HPO doesn't

Retrieval of HPO terms: 
...
To find paired hyper/hypo terms: cat ../resources/HPO.terms.with.hyper.txt ../resources/HPO.terms.with.hypo.txt | ./hyperHypoOpposites.pl

To find paired increased/decreased terms: cat ../resources/HPO.terms.with.increased.txt ../resources/HPO.terms.with.decreased.txt | ./increasedDecreasedOpposites.pl
